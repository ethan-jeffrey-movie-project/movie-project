...
//
// function loadMoviesByGenres(swiperIds, genreIds) {
...
// 					const genreMovies = responses.map((response) => {
// 						return response.results.filter((movie) => movie.genre_ids.includes(genreId));
// 					});
//
...
// 						populateMovies(genreSwiperWrapper, genreMovies[index], `genre-${genreIds[index]}`);
//
...
// 			card.classList.add(`${genre.name.toLowerCase()}-movie`);
// 		}
//
...
// }
//
// loadMoviesByGenres("action-swiper", "28")